...
1. **Cumulocity Tenant:**
   ...
   * The **[Service Request Mgmt Service](https://github.com/Cumulocity-IoT/cumulocity-microservice-service-request-mgmt/)** microservice must be pre-deployed on the tenant.
